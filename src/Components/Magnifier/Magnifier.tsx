//https://github.com/samuelmeuli/react-magnifier/blob/master/src/Magnifier.tsx
//modified for smoother image loading
import "./style.css";
...
export default class Magnifier extends PureComponent<Props, State> {
  ...
  onTouchMove = (e: TouchEvent): void => {
    ...
    if (this.imgBounds) {
      ...
      const relX =
        (e.targetTouches[0].clientX - this.imgBounds.left) / target.clientWidth;
      const relY =
        (e.targetTouches[0].clientY - this.imgBounds.top) / target.clientHeight;
